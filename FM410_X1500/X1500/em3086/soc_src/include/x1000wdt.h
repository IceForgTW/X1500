/*
 * linux/include/asm-mips/mach-jz4775/jz4775wdt.h
 *
 * JZ4775 WDT register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4775WDT_H__
#define __JZ4775WDT_H__
...
#define __wdt_get_count(v)		( REG_WDT_TCNT)
#define __wdt_set_data(v)		( REG_WDT_TDR = (v) )
#define __wdt_get_data(v)		( REG_WDT_TDR )
