...
#define DMAC_DSD(n)   (DMAC_BASE + (0x1C + (n) * 0x20)) /* DMA Stride Address */
...
#define DES_RDIL_MASK		( 0xF << 14)
#define	DES_RDIL_1BYTES		( 1 << 14 )
#define	DES_RDIL_2BYTES		( 2 << 14 )
#define	DES_RDIL_3BYTES		( 3 << 14 )
#define	DES_RDIL_4BYTES		( 4 << 14 )
#define	DES_RDIL_8BYTES		( 5 << 14 )
#define	DES_RDIL_16BYTES	( 6 << 14 )
#define	DES_RDIL_32BYTES	( 7 << 14 )
#define	DES_RDIL_64BYTES	( 8 << 14 )
#define	DES_RDIL_128BYTES	( 9 << 14 )
