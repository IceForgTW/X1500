/*
 * linux/include/asm-mips/mach-jz4775/jz4775rtc.h
 *
...
#ifndef __JZ4775RTC_H__
#define __JZ4775RTC_H__
...
#define RTC_OWIPCR	(RTC_BASE + 0x44) /* Identify the OWI pin value */
#define RTC_PWRONCR	(RTC_BASE + 0x48) /* Identify the RTC battery has been removed */
...
#define REG_RTC_OWIPCR	REG32(RTC_OWIPCR)
