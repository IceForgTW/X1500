...
#define JZFS_CMD_IGNORE_FLUSH_CACHE    5001L
#define JZFS_CMD_NO_IGNORE_FLUSH_CACHE 5002L
#define JZFS_CMD_RAM_SPACE_ALLOC    5003L
#define JZFS_CMD_RAM_SPACE_FREE     5004L
#define JZFS_CMD_SET_VOLUME_LABEL   5005L
#define JZFS_CMD_GET_VOLUME_LABEL   5006L
...
JZFS_FILE          *jzfs_Open2            (const char       *sFileName,
                                          const char       *sMode, JZFS_FILE *handle);

void                jzfs_Close2           (JZFS_FILE        *pstFile);
...
int                 jzfs_Exit            (void);
int                 jzfs_IsMount         (const char * DevName);

void                jzfs_CloseAll(); 

int                 jzfs_GetOpenedFileCount();
