/*
 * linux/include/asm-mips/mach-jz4775/jz4775i2c.h
 *
 * JZ4775 I2C register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4775I2C_H__
#define __JZ4775I2C_H__
...
#define I2C_SDAHD(n)		(I2C0_BASE + (n)*0x1000 + 0x7C)
 ...
 * I2C
 ***************************************************************************/
#define __i2c_standar_speed(n)	( REG_I2C_CTRL(n) = 0x43)
#define __i2c_7bit_addr(n)	( REG_I2C_TAR(n) &= ~I2C_TAR_MATP)
//#define __i2c_10bit_addr(n)	( REG_I2C_CTRL(n) |= I2C_CTRL_MATP)
