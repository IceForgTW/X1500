/*
 * linux/include/asm-mips/mach-jz4775/jz4775uart.h
 *
 * JZ4775 UART register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4775UART_H__
#define __JZ4775UART_H__
...
#define UART0_URCR	(UART0_BASE + OFF_URCR)
#define UART0_UTCR	(UART0_BASE + OFF_UTCR)
...
#define UART1_UMR	(UART1_BASE + OFF_UMR)
#define UART1_UACR	(UART1_BASE + OFF_UACR)
#define UART1_URCR	(UART1_BASE + OFF_URCR)
#define UART1_UTCR	(UART1_BASE + OFF_UTCR)
...
#define UART2_UMR	(UART2_BASE + OFF_UMR)
#define UART2_UACR	(UART2_BASE + OFF_UACR)
#define UART2_URCR	(UART2_BASE + OFF_URCR)
#define UART2_UTCR	(UART2_BASE + OFF_UTCR)
