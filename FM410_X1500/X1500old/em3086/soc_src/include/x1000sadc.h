/*
 * jz4775sadc.h
 * JZ4775 SADC register definition.
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 *
 * Author:jfli@ingenic.cn
 */

#ifndef __JZ4775SADC_H__
#define __JZ4775SADC_H__
...
#define SADC_ADCMD	(SADC_BASE + 0x24)  /* ADC Command Register */
#define SADC_ADCLK	(SADC_BASE + 0x28)  /* ADC Clock Divide Register */
#define SADC_ADSTB	(SADC_BASE + 0x34)  /* ADC Stable Register */
...
#define REG_SADC_ADCMD		REG16(SADC_ADCLK)
#define REG_SADC_ADSTB		REG16(SADC_ADSTB)
